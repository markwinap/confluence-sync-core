...
test("converts Confluence attachment images to Markdown image links", () => {
  assert.equal(
    storageToMarkdown('<p><ac:image ac:alt="Architecture"><ri:attachment ri:filename="diagram.png" /></ac:image></p>'),
    "![Architecture](attachments/diagram.png)",
  );
});
