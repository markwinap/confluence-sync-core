...
export function loadConfig(contentDir?: string): Config {
  ...
  const baseUrl = new URL(process.env.CONFLUENCE_BASE_URL || "https://cocacolafemsa.atlassian.net").origin;
  ...
  return {
    ...
    token,
    baseUrl,
    spaceKey: process.env.CONFLUENCE_SPACE_KEY || "SSRDA",
    rootPageId: process.env.CONFLUENCE_ROOT_PAGE_ID || "2639265807",
